...
from nils.edf.outer_parallel.outer_parallel_edf_axial_ducted_radiator_integrator import (
    integrate_outer_parallel_edf_axial_ducted_radiator,
)
from nils.edf.outer_parallel.outer_parallel_edf_axial_ducted_radiator_plotter import (
    plot_outer_parallel_edf_axial_ducted_radiator,
)
...
out_dict = integrate_outer_parallel_edf_axial_ducted_radiator(in_dict)

#%%

plot_outer_parallel_edf_axial_ducted_radiator(out_dict)
