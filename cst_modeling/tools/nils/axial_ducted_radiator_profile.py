...
class PoweredNacelleProfile():
    ...
    def set_parameters(self, theta_spinner: float, r_spinner: float, r_fan: Union[None, float], 
        ...
        # =============================================================================
        self.params['h_camber_bump'] = h_camber_bump
        self.params['xc_camber_bump']= xc_camber_bump
        # =============================================================================
    ...
    def calculate_profile_segments(self) -> None:
        ...
        # #* (0,6) HX inner radius
        self.profile_segments[6] = self.create_straight_line(   self.segment_points[0][0], self.segment_points[0][1],
                                                                self.segment_points[6][0], self.segment_points[6][1])
        
        #* (2,5) HX outer radius
        self.profile_segments[7] = self.create_straight_line(   self.segment_points[2][0], self.segment_points[2][1],
                                                                self.segment_points[5][0], self.segment_points[5][1])
        ...
        profile_segments_4_interp = interp1d(
            self.profile_segments[4][:, 0], self.profile_segments[4][:, 1],
        )
        x8 = self.segment_points[4][0] - 0.4  # - l_nozzle - l_fan
        y8 = profile_segments_4_interp(x8)
        x9 = self.segment_points[4][0] - 0.15  # - l_nozzle
        y9 = profile_segments_4_interp(x9)
        ...
        self.profile_segments[10][:, 0] = np.linspace(x8, x9, self.n_point_segment)
        self.profile_segments[10][:, 1] = profile_segments_4_interp(self.profile_segments[10][:, 0])
        
        #* Fan hub
        self.profile_segments[11] = np.zeros((self.n_point_segment, 2))
        self.profile_segments[11][:, 0] = np.linspace(x8, x9, self.n_point_segment)
        self.profile_segments[11][:, 1] = np.zeros(self.n_point_segment)
        # =============================================================================
    ...
    def outer_cowl_profile(self) -> None:
        ...
        # =============================================================================
        # geo_old = FoilGeoFeatures(self._xx, self._yu, self._yl)

        modify = FoilModification(self._xx, self._yu, self._yl)
        
        xc, h, w = (self.params['xc_camber_bump'], self.params['h_camber_bump'], 1.0)
        # xc, h, w = (0.3, 0.0, 1.0)
        ...
        self.camber_geo_new = geo_new.get_feature('camber')
        
        self._xx, self._yu, self._yl = modify.x, modify.yu, modify.yl
        # =============================================================================
